  ...
  >
    <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <Link to="/" className="flex items-center gap-2.5 group">
        <div className="w-8 h-8 rounded-lg bg-white flex items-center justify-center shadow-xl group-hover:shadow-[0_0_16px_oklch(0.62_0.17_158/40%)] transition-shadow">
...
const Footer = () => (
  <footer className="border-t border-[oklch(0.91_0.004_240)] dark:border-[oklch(1_0_0/9%)] py-10 px-6">
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
      ...
      <span className="text-sm text-[oklch(0.72_0.005_255)]">© 2024 T.Learn</span>
    </div>
  </footer>
);
