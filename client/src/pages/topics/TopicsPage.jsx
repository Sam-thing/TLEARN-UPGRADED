...
const TopicsPage = () => {
  ...
  const handleStartLearning = (topicId) => {
    navigate(`/teach/${topicId}`); // Navigate to TeachPage
  };
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-DM Mono, monospace text-2xl font-semibold text-text-dark dark:text-foreground">
              Popular <span className="text-green-700">Topics</span>
            </h2>
          </div>
        ...
        {filteredTopics.length > 0 ? (
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <h3 className="font-DM Mono, monospace text-lg mb-2">No topics found</h3>
...
const CreateTopicDialog = ({ onSuccess, onClose }) => {
  ...
  try {
    ...
    const response = await topicService.create(dataToSubmit);
